...
//
// ⚠️ O caminho do DANFSe (PDF) NÃO aparece nesse Swagger — o spec baixado só
// documenta a tag "DistribuicaoContribuinte". O caminho usado abaixo
// (PATHS.danfse) é um palpite ainda não confirmado; se o botão "Baixar PDF"
// falhar, é aqui que precisa investigar (pode ser uma API separada, talvez
// pública, de consulta do DANFSe).
//
...
const PATHS = {
  ...
  // GET -> PDF (DANFSe) pronto pra imprimir/conferir. NÃO confirmado no
  // Swagger (ver aviso no topo) — pode estar errado.
